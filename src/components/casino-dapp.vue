          ...
          <div class="left">
            ...
            <div class="container-action">
              ...
              <div class="right" style="padding-right: 24px; padding-top: -16px; margin-top: -8px;">
                ...
                <button class="mdc-button mdc-button--raised" v-on:click="clickDonar">Donar</button>
              </div>              
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      objects: [
        {
          id: 1,
          foto_url: "../assets/brazo-robot.jpg",
          titulo: "",
          desc: "",
          fecha_fin: "",
          monto_requerido: "",
  ...
  methods: {
    clickDonar(event) {
      ...
      this.winEvent = null;
      this.pending = true;
      this.$store.state.contractInstance().donar(event.target.innerHTML, {
          gas: 300000,
